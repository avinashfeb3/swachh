...
<body>
    ...
    <main>
        ...
        <section class="aboutus_wrapper">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 aboutus-intro">
        ...
        <!--  Press Note Section Start -->
        <section class="press_wrapper">
            <div class="container align-items-center justify-content-center">
                <div class="row">
                    <div class="col-lg-12">
                        <h4 class="text-center align-items-center justify-content-center">Press Note</h4>
                    </div>
                    <div class="press_card mt-3 mb-3 pt-3 pb-3">
                        <div class="row row-cols-1 row-cols-md-4 g-4">
                            <div class="col-sm-3">
                                <div class="card">
                                    <div class="card-body">
                                        <span>01-May-2024</span>
                                        <h5 class="card-title">Ministry of Electronics & Information Technology</h5>
                                        <p class="card-text">Ministry of Electronics & Information Technology (Meity)
                                            has been selected as one of the best Ministiries and awarded Swachh Bharat
                                            Award 2009</p>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <div class="partner-logos mt-3 mb-3 pt-3 pb-3">
                            ...
                            <div class="partner-logo"><img src="./images/partner/partner3.png" alt="Partner Logo 3">
                            </div>
                            <div class="partner-logo"><img src="./images/partner/partner2.png" alt="Partner Logo 2">
                            </div>
                            <div class="partner-logo"><img src="./images/partner/partner1.png" alt="Partner Logo 1">
